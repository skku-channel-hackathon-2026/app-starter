# SKKU 2026 app-starter — Channel App
...
**공통 템플릿입니다. 이 레포 자체는 자동 배포 대상이 아닙니다.** 참가팀은 이미 생성된 team1~team11을, 준비위는 team0를 사용하세요. 복사한 새 레포에는 별도 Worker·D1·앱·웹훅 연결이 필요합니다.
...
```sh
git clone https://github.com/skku-channel-hackathon-2026/app-starter.git
cd app-starter
corepack enable
